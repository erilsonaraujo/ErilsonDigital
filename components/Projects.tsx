        ...
        <section id="portfolio" className="py-24 bg-white dark:bg-dark-950 transition-colors duration-300 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <button
                        onClick={prevProject}
                        className="absolute left-2 md:left-4 top-1/2 -translate-y-1/2 z-30 p-2 md:p-3 rounded-full bg-white/80 dark:bg-dark-800/80 backdrop-blur-sm border border-slate-200 dark:border-dark-700 text-slate-700 dark:text-white shadow-lg hover:scale-110 transition-all focus:outline-none"
                        aria-label="Anterior"
                    >
                    ...
                    <button
                        onClick={nextProject}
                        className="absolute right-2 md:right-4 top-1/2 -translate-y-1/2 z-30 p-2 md:p-3 rounded-full bg-white/80 dark:bg-dark-800/80 backdrop-blur-sm border border-slate-200 dark:border-dark-700 text-slate-700 dark:text-white shadow-lg hover:scale-110 transition-all focus:outline-none"
                        aria-label="Próximo"
                    >
                    ...
                    <div className={`transition-opacity duration-500 ease-in-out ${isAnimating ? 'opacity-0' : 'opacity-100'}`}>
                        <div className="glass-card rounded-3xl overflow-hidden shadow-2xl flex flex-col lg:flex-row min-h-[600px]">
                            ...
                            {/* Info Section */}
                            <div className="lg:w-2/5 p-8 md:p-12 flex flex-col justify-between bg-white/50 dark:bg-dark-900/50 backdrop-blur-md">
                                <div>
                                ...
                                <div className="mt-8">
                                    <div className="flex flex-wrap gap-2 mb-8">
                                        {project.technologies.map(tech => (
                                            <span key={tech} className="text-xs font-semibold px-2.5 py-1 rounded-md bg-white/50 dark:bg-dark-800/50 border border-slate-200 dark:border-dark-700 text-slate-600 dark:text-slate-400">
                                                {tech}
                                            </span>
                                        ))}
                                    </div>
