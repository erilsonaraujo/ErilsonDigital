        ...
        <footer className="bg-ink-950 border-t border-graphite-800 py-14">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr_0.8fr] gap-10">
                    ...
                    <div className="space-y-4">
                        <p className="text-xs uppercase tracking-[0.3em] text-graphite-500">Soluções</p>
                        <div className="space-y-3 text-sm text-graphite-300">
                            <a href="/clinicas-estetica" className="block hover:text-white">Clínicas de Estética</a>
                            <a href="/cirurgia-dermato-premium" className="block hover:text-white">Cirurgia Plástica & Dermato</a>
                            <a href="/odontologia-premium" className="block hover:text-white">Odontologia Premium</a>
                        </div>
                    </div>
