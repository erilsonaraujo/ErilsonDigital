      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
            ...
            <div className="flex justify-end gap-2 mb-4 md:absolute md:-top-24 md:right-0">
                <button onClick={prevSlide} className="p-2 rounded-full border border-slate-300 dark:border-dark-700 hover:bg-white dark:hover:bg-dark-800 transition-colors">
                    <ChevronLeft className="w-5 h-5 text-slate-600 dark:text-slate-300" />
                </button>
                <button onClick={nextSlide} className="p-2 rounded-full border border-slate-300 dark:border-dark-700 hover:bg-white dark:hover:bg-dark-800 transition-colors">
            ...
            {visibleTestimonials.map((t) => (
                <div key={t.id} className="bg-white dark:bg-dark-800 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-dark-700 flex flex-col h-full animate-in fade-in duration-500">
