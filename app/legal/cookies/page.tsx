      ...
      <div className="max-w-4xl mx-auto">
        <div className="rounded-[32px] border border-graphite-800 bg-ink-900/80 p-10 text-graphite-200">
          ...
          <div className="space-y-6 text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-lg font-semibold text-graphite-900 mb-2">Cookies essenciais</h2>
              <p>Garantem o funcionamento do site e protecoes basicas de seguranca.</p>
            </div>
            <div>
              <h2 className="text-lg font-semibold text-graphite-900 mb-2">Cookies de analise</h2>
              <p>Coletam dados anonimizados para entender comportamento e otimizar resultados.</p>
            </div>
            <div>
              <h2 className="text-lg font-semibold text-graphite-900 mb-2">Gerenciamento</h2>
